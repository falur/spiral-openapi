...
final readonly class OpenApiGeneratorConfig
{
     ...
     */
    public function __construct(public string $projectRoot, public array $sourcePaths, public string $apiNamespace, public string $routePrefix, public string $outputFile, public string $title, public string $version, public ResponseWrapperMapping $responseWrapperMapping, public string $openApiVersion = '3.1.0', public bool $debug = false, public BearerSecurityConfig|null $bearerSecurity = null) {}
    public function validate(): void
    {
        $this->bearerSecurity?->validate();
        if ($this->sourcePaths === []) {
